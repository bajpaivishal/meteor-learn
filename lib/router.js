FlowRouter.route('/', {
    action: function (params, queryParams) {
        FlowLayout.render('layout1', { main: "hello" });
...
// FlowRouter.go('/post/my-post?comments=on&color=dark');
...
FlowRouter.route('/about', {
    action: function (params, queryParams) {
        FlowLayout.render('layout1', { top: "header", main: "about" });
    }
});
FlowRouter.route('/contact', {
    action: function (params, queryParams) {
        FlowLayout.render('layout1', { top: "header", main: "contact" });
    }
});
